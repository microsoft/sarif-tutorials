...
<a id="notification-metadata"></a>**notification metadata**: Information that describes a notification produced by
...
for example, what options were selected or which rules were enabled and disabled.
